...
<!-- Mirrored from agmstudio.io/themes/material-style/2.4.0/home-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 May 2019 14:36:00 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>CloudAge varshaaaa</title>
    <meta name="description" content="Material Style Theme">
    <link rel="shortcut icon" href="assets/img/ab.ico?v=3">
      ...
      <nav class="navbar navbar-expand-md navbar-fixed ms-lead-navbar navbar-mode navbar-mode mb-0" id="navbar-lead">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php">
              ...
              <span class="fix-logo"><img src="assets/img/logo.png" width="160px">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
             <li class="nav-item dropdown dropdown-megamenu-container">
                      ...
                      <div class="col-sm-4 megamenu-col">
                        <div class="megamenu-block animated fadeInLeft animated-2x">
                          <h3 class="megamenu-block-title">
                            ...
                            <li>
                          <br>    <a class="withripple" href="">Hadoop As A Service</a>
                                <ul>
                                  <li>
              ...
              <li class="nav-item dropdown">
				...
				<li>
                    <a href="hrservices.php" class="no-focus animated zoomInDown animation-delay-8 dropdown-item">HR Services</a>
                </li>  
            
                     
				<li>
                    <a href="universityServices.php" class="no-focus animated zoomInDown animation-delay-8 dropdown-item">University Services</a>
				</li> 
				 
				 
				 <li>
                    <a href="consultancyServices.php" class="no-focus animated zoomInDown animation-delay-8 dropdown-item">Consultancy Services</a>
				</li> 
			...
			<!--	<li>
                    <a href="aboutus.php" class="no-focus animated zoomInDown animation-delay-8 dropdown-item">About Us</a>
				</li>  -->				  
              </ul>
            </li>
			
			<li class="nav-item">
                <a data-scroll="" class="nav-link" href="aboutus.php">About us<div class="ripple-container"></div></a>
              </li>
         <!-- <li class="nav-item">
        ...
        <!--   <li class="nav-item">
            ...
            <h6 data-toggle="tooltip" data-template="<div class=&quot;tooltip tooltip-warning&quot; role=&quot;tooltip&quot;><div class=&quot;tooltip-inner&quot;></div></div>" data-placement="top" title="" data-original-title="Register For Live Webinar"> <a href="javascript:void(0)" data-toggle="modal" data-target="#ms-account-modal">Live Webinar<div class="ripple-container"></div></a> <div class="ripple-container"></div></h6>
           
             <a href="javascript:void(0)" data-toggle="modal" data-target="#ms-account-modal"><p id="timer" style="color: rgb(255, 152, 0);">EXPIRED</p></a>
          </div>
         <!-- <li class="nav-item">
