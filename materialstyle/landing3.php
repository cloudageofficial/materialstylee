<?php include('header.php');?>
      <div class="intro-full ms-hero-img-city2 ms-hero-bg-primary color-white" id="home">
        <div id="intro-video" class="plyr__video-embed">
          <iframe src="https://www.youtube.com/embed/V-FgQ2NAGFc?rel=0&amp;controls=0&amp;showinfo=0&amp;autoplay=1&amp;loop=1&amp;playlist=V-FgQ2NAGFc" frameborder="0" allow="autoplay" allowfullscreen></iframe>
        </div>
