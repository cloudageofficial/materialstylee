    ...
    <link rel="stylesheet" href="assets/css/width-boxed.min.css" id="ms-boxed" disabled="">
      ...
      <div class="container">
        <div class=" col-md-7 offset-md-4">
          ...
          <div class="card-body">
		 <!-- <a href="assets/img/CAcertificate.jpeg" data-lightbox="image-1" data-title="My caption">Certificate</a>-->
		  
		  <div class="col-lg-7">
                      <a href="assets/img/CAcertificate.jpeg" data-lightbox="port-1" data-title="CAcertificate" class="img-thumbnail withripple">
                        <div class="thumbnail-container">
                          <img src="assets/img/CAcertificate.jpeg" alt="..." class="img-fluid"> </div>
                      <div class="ripple-container"></div></a>
                    </div>
	<!--	<span><p><img src="assets/img/CAcertificate.jpeg" style="width:50%; height:40%;"><p></span>
